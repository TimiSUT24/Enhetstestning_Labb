    ...
    public static class UserInterface
    {
        public static void DisplayMenu(LibrarySystem library)
        {
            ...
            while (running)
            {
                ...
                Console.WriteLine("8. Is book overdue");
                ...
                if (int.TryParse(Console.ReadLine(), out int choice))
                {
                    switch (choice)
                    {
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            UserInterface.IsBookOverDue(library);
                            break;
                        case 9:
                            running = false;
                            break;
            ...
            if (int.TryParse(Console.ReadLine(), out int choice))
            {
                ...
                switch (choice)
                {
                    ...
                    case 3:
                        Console.Write("Enter ISBN: ");
                        searchTerm = Console.ReadLine();
                        results = library.SearchByISBNPartial(searchTerm);                    
                        break;
                    default:
        ...
        public static void IsBookOverDue(LibrarySystem library)
        {
            Console.Clear();
            Console.WriteLine("=== Check if Book is Overdue ===");
            Console.Write("Enter ISBN of book: ");
            string isbn = Console.ReadLine();          
            if(int.TryParse(Console.ReadLine(), out int loandays))
            {
                bool isOverdue = library.IsBookOverdue(isbn, loandays);               
                if (isOverdue == true)
                {
